    ...
    return (
      <div className="mt-4 rounded-xl border border-red-500/70 bg-red-900/30 px-4 py-3 text-sm text-red-100">
        <h3 className="mb-1 text-red-300 font-semibold">
          ⚠ The code you entered does not match any verified INFUSED Nutrition
          product.
        </h3>
        <p>
          {result.message ||
            "Please double-check the code printed on your product's tamper-proof seal."}
        </p>
        {result.usedAt && (
      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 pt-2 pb-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 text-xs text-gray-400">
          <button
            type="button"
            onClick={() => navigate("/")}
            className="inline-flex items-center gap-2 cursor-pointer hover:text-[#f5b014] transition-colors"
          >
        ...
        <header className="mb-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight">
            ...
            <span className="block bg-gradient-to-r from-[#f5b014] to-yellow-400 bg-clip-text text-transparent">
              AUTHENTICITY
            </span>
          </h1>

          <p className="mt-3 text-sm text-gray-400 max-w-lg">
            Enter the unique 12-character code found on the tamper-proof seal
            of your INFUSED product to confirm its authenticity.
          </p>
        </header>
        ...
        <main className="flex flex-col items-center flex-1">
          <div
            className="
            w-full 
            max-w-sm sm:max-w-lg md:max-w-3xl
            rounded-2xl 
          ...
          >
            ...
            {/* Input Section */}
            <p className="text-xs tracking-wider text-[#f5b014] uppercase font-semibold">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <p className="text-center text-[10px] sm:text-xs text-gray-500 -mt-1">
                The code is usually printed near the expiration date or under
                the cap.
              </p>
          ...
          >
            <div className="flex items-start gap-4">
              <div className="h-10 w-10 flex items-center justify-center rounded-full bg-yellow-500/10 text-xl">
                📦
              </div>

              <div className="flex-1">
                <p className="text-xs font-semibold tracking-[0.2em] text-[#f5b014] uppercase">
                  Code Location
                </p>

                <p className="text-xs text-gray-400 mt-1">
                  Look for the 12-character alphanumeric code printed on the
                  tamper-proof seal.
                </p>

                <ul className="mt-3 space-y-1 text-xs text-gray-400">
                  <li className="flex gap-2">
                    <span className="text-[#f5b014]">•</span> On the hologram
                    sticker or security seal.
                  </li>
                  <li className="flex gap-2">
                    <span className="text-[#f5b014]">•</span> Near the printed
                    MFG / EXP date.
                  </li>
                  <li className="flex gap-2">
                    <span className="text-[#f5b014]">•</span> Do not share your
                    code publicly.
                  </li>
                </ul>
              </div>
