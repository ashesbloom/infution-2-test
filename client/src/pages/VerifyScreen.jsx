...
const VerifyScreen = () => {
  ...
  const renderResultCard = () => {
    ...
    return (
      <div className="mt-4 rounded-xl border border-red-500/70 bg-red-50 px-4 py-3 text-sm text-red-600">
      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 pt-2 pb-6 sm:px-6 lg:px-8">
        ...
        <header className="mb-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight">
            <span className="block text-gray-800">VERIFY</span>
        ...
        <main className="flex flex-col items-center flex-1">
          <div className="w-full max-w-sm sm:max-w-lg md:max-w-3xl rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 to-gray-100 p-4 sm:p-6 shadow-xl shadow-emerald-500/10">
            {/* Error above input */}
            {error && (
              <div className="mb-3 w-full rounded-lg border border-red-500 bg-red-50 px-4 py-2 text-center text-sm text-red-600 font-medium shadow">
                ⚠ {error}
              </div>
            )}
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="rounded-xl border border-gray-300 bg-white p-3 sm:p-4 shadow-inner">
                <input
                  type="text"
                  maxLength="12"
                  ...
                  className="w-full bg-transparent text-center text-base sm:text-lg tracking-[0.25em] font-semibold text-gray-700 placeholder:text-gray-600 focus:outline-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 sm:py-3 rounded-xl bg-[#06a34f] hover:bg-emerald-500 transition text-gray-800 font-semibold tracking-wide text-xs sm:text-sm disabled:opacity-60"
              >
          ...
          {/* Bottom Info Card */}
          <div className="w-full max-w-sm sm:max-w-lg md:max-w-3xl mt-8 rounded-2xl border border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 px-4 sm:px-6 py-5 sm:py-6 shadow-lg">
